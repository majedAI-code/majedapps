...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-2.467-2.51-2.225h3.095l.569-2.467.569 2.467h3.095l-2.51 2.225.569 2.467z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 01-9-9V6a2 2 0 012-2h10a2 2 0 012 2v6a9 9 0 01-9 9z" />
    </svg>
);
...
export const ResizeIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
...
export const EnhanceIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 17l-4 4-4-4 9.293-9.293a1 1 0 011.414 0L15 9.586M17 11l4-4" />
    </svg>
);
